...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/footer.css"> <!-- You can define this stylesheet -->
</head>
<body>

<div class="footer">
    <!-- Footer -->
    <footer class="bg-[#8ec6db] mt-auto">
    <div class="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 border-b border-black">
        ...
        <i class="fas fa-paw text-black text-xl">
        </i>
        </div>
        <span class="font-greatvibes text-xl select-none mb-3">
        MaVetCare
        </span>
        <p class="text-center text-sm max-w-[180px]">
        ...
        <i class="fas fa-paw text-black text-sm">
        </i>
        </div>
        </div>
        ...
        <img alt="footer dogs" class="absolute bottom-0 right-0 max-w-[150px] md:max-w-[200px]" height="150" src="footer_lower_right.png" style="transform: translateY(20%)" width="150"/>
        </div>
    </div>
    ...
    <img alt="footer cat" class="absolute bottom-0 left-0 max-w-[100px] md:max-w-[150px]" height="100" src="footer_lower_left.png" style="transform: translateY(20%)" width="100"/>
    </footer>